...
class DensityS1
{
    public:
        ...
        double density(double c0=0.75,  unsigned int nfft=524288, unsigned int data_length=344656) const; // Do not need ephemeris (to set data length)
