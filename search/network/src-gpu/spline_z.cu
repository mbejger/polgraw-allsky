...
void gpu_interp(cufftDoubleComplex *cu_y, int N, 
		double *cu_new_x, cufftDoubleComplex *cu_new_y,
		int new_N, cufftDoubleComplex *cu_d, 
		cufftDoubleComplex *cu_dl, cufftDoubleComplex *cu_du,
